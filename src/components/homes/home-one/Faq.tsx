...
import faq_1 from "@/assets/images/contact/mental-health-care_13.png"
            ...
            <div className="row">
               <div className="col-xl-6">
                  <div className="contact-two_image-box p-r z-1 mb-50">
                     <Image src={faq_1} className="image-one" alt="Contact Image" />
                     <Image src={faq_2} className="image-two" alt="Contact Image" />
                     <Image src={faq_3} className="image-three" alt="Contact Image" />
                     ...
                     <div className="accordion" id="accordionOne">
                        {faq_data.filter((items) => items.page === "home_1").map((item) => (
                           <div key={item.id} className="accordion-card style-one mb-15">
                              ...
                              <div id={`collapse${item.id}`} className={`accordion-collapse collapse ${activeId === item.id ? "show" : ""}`}>
